    ...
    for i in range(len(X)):
        ...
        for j in range(len(X)):
            if i!=j:
                ...
                # print(f"theta_AB: {theta_BA}")
                if 2*ROB_RAD > dist_BA:
                    dist_BA = 2*ROB_RAD
                # print(f"dist_BA: {dist_BA}")
                # print(f"minkowski sum: {2*ROB_RAD}")
                ...
                # print(f"RVO: {[transl_vB_vA, degrees(theta_ort_left), degrees(theta_ort_right)]}")
