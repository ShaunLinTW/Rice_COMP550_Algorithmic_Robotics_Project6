...
def pygame_visualize(ws_model, X, U, goal, time = None, name=None):
    ...
    for hole in ws_model['circular_obstacles']:
        pygame.draw.rect(screen, (0,0,255), ((hole[0]-hole[2])*100, 
(hole[1]-hole[2])*100, 100*hole[2], 100*hole[2]), outlineThickness)
...
def visualize_traj_dynamic(ws_model, X, U, goal, time = None, name=None):
    ...
    # set map size 50m by 50m
    # ax.set_xlim(0.0, 50.0)
    # ax.set_ylim(0.0, 50.0)
    # set map size 100m by 100m
...
if __name__ == '__main__':
    ...
    # in the center of 30m by 30m map, place 4 circular obstacles
    # [10, 10, 3.0]
    # [20, 10, 3.0]
    # [10, 20, 3.0]
    # [20, 20, 3.0]
    # ws_model['circular_obstacles'] = [[10, 10, 3.0], [20, 10, 3.0], [10, 20, 3.0], [20, 20, 3.0]]
